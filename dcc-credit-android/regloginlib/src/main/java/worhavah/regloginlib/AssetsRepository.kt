...
class AssetsRepository(
  ...
  /*  fun getQuotes(vararg symbols: String): Single<List<Quote>> {
        return chainFrontEndApi.getQuotes(symbols.joinToString(",")).subscribe(
            {
                it.forEach {
                    it.computeChange()
                    quoteCache[it.varietyCode] = it
   ...
   // }
    ...
    companion object {
        ...
        val preset = listOf<DigitalCurrency>(
                DigitalCurrency("DATA", Chain.publicEthChain, 18, "DATA", "http://open.dcc.finance/images/dapp/product_data.png", "0x69b148395ce0015c13e36bffbad63f49ef874e03"),
