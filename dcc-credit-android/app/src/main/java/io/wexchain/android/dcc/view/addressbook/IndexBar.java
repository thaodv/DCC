...
public class IndexBar extends View {
     ...
     */
    public void setOnTouchingLetterChangedListener(OnTouchingLetterChangeListener
    ...
    private void initSetting(Context context, AttributeSet attrs) {
        ...
        int letterColor = typedArray.getColor(R.styleable.IndexBar_letterColor, ContextCompat.getColor
                (getContext(), android.R.color.white));
        mLetterSpacingExtra = typedArray.getFloat(R.styleable.IndexBar_letterSpacingExtra, 1.4f);
        int focusLetterColor = typedArray.getColor(R.styleable.IndexBar_focusLetterColor, ContextCompat
