 ...
 * usage:
 */
public class AcrossTransPublic2PrivateDialog extends Dialog implements View.OnClickListener {
    ...
    public AcrossTransPublic2PrivateDialog(@NonNull Context context) {
        super(context, R.style.deleteAddressBookDialog);
        WindowManager.LayoutParams attributes = getWindow().getAttributes();
        attributes.gravity = Gravity.CENTER;
        getWindow().setAttributes(attributes);
        setContentView(R.layout.dialog_across_trans_public2private);
