package io.wexchain.android.dcc.view.passwordview;
...
/**
 * @author Created by Wangpeng on 2019/3/5 15:42.
 * usage:
 */
public class PassWordView extends View {
        ...
        if (isDrawText) {
            ...
            switch (mShowPassType) {
                ...
                case 1:
                    ...
                    float baseY = (getMeasuredHeight() / 2 - ((mPaint.descent() + mPaint.ascent()) / 2)) +
                            stringWidth / 3;  //实现y轴居中方法
                ...
                case 2:
                    ...
                    float baseY2 = (getMeasuredHeight() / 2 - ((mPaint.descent() + mPaint.ascent()) / 2)) +
                            stringWidth2 / 5;  //实现y轴居中方法
    ...
    private void drawRemindLine(Canvas canvas) {
        if (mDrawRemindLineState && isShowRemindLine) {  // mDrawRemindLineState 控制闪烁情况  //isShowRemindLine
            // 是否绘制提示线
            ...
            canvas.drawLine(getMeasuredWidth() / 2, getMeasuredHeight() / 2 - line_height / 2,
                    getMeasuredWidth() / 2, getMeasuredHeight() / 2 + line_height / 2, mPaint);
        }
    }
