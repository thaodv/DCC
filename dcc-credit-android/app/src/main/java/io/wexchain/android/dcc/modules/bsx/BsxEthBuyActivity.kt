...
import io.wexchain.android.dcc.tools.fixPrice
...
class BsxEthBuyActivity : BindActivity<ActivityBsxEthBuyBinding>() {
    ...
    private fun initView() {
        ...
        val sp = BsxDetailActivity.ONAME + "（剩余额度 " + BsxDetailActivity.LASTAM + " ETH）"
    ...
    private fun checkBalance() {
        App.get().assetsRepository.getDigitalCurrencyAgent(Currencies.Ethereum)
