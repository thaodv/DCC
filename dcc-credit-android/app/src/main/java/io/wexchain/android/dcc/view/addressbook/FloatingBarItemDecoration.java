 ...
 */
package io.wexchain.android.dcc.view.addressbook;
...
public class FloatingBarItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatingBarItemDecoration(Context context) {
        ...
        mTextPaint.setTextSize(mContext.getResources().getDimensionPixelSize(R.dimen
                .item_decoration_title_fontsize));
    ...
    private void drawTitleArea(Canvas c, int left, int right, View child, RecyclerView.LayoutParams params,
        ...
        c.drawText(mList.get(position), child.getPaddingLeft() + mTextStartMargin, rectBottom -
                (mTitleHeight - mTextHeight) / 2 - mTextBaselineOffset, mTextPaint);
    }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        c.drawRect(parent.getPaddingLeft(), parent.getPaddingTop(), parent.getRight() - parent
                .getPaddingRight(), parent.getPaddingTop() + mTitleHeight, mBackgroundPaint);
        c.drawText(initial, child.getPaddingLeft() + mTextStartMargin, parent.getPaddingTop() +
                mTitleHeight - (mTitleHeight - mTextHeight) / 2 - mTextBaselineOffset, mTextPaint);
