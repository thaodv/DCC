...
class TokenTest {
    ...
    fun testgetbiStatues() {
        val getAllowance = Erc20Helper.getStatus(contract,owner.address,splenderC.address)
    ...
    fun testgetbiSaleInfo() {
        val getAllowance = Erc20Helper.getSaleInfo(contract,owner.address,splenderC.address)
        val response = bintApi.postStatus(
            EthJsonRpcRequestBody(
                method = "eth_call",
                params = listOf(getAllowance, "latest"),
    ...
    fun testgetbiminAmountPerHand() {
        val getAllowance = Erc20Helper.getMinAmountPerHando(contract,owner.address,splenderC.address)
        val response = bintApi.postStatus(
            EthJsonRpcRequestBody(
                method = "eth_call",
                params = listOf(getAllowance, "latest"),
    ...
    fun testgetbiInvestCeilAmount() {
        val getAllowance = Erc20Helper.getInvestCeilAmount(contract,owner.address,splenderC.address)
        val response = bintApi.postStatus(
            EthJsonRpcRequestBody(
                method = "eth_call",
                params = listOf(getAllowance, "latest"),
    ...
    fun testgetbiInvestedTotalAmount() {
        val getAllowance = Erc20Helper.investedTotalAmount(contract,owner.address,splenderC.address)
        val response = bintApi.postStatus(
            EthJsonRpcRequestBody(
                method = "eth_call",
                params = listOf(getAllowance, "latest"),
    ...
    @Test
    fun testInvest(){
        val approve = Erc20Helper.invest(  BigInteger.ZERO)
