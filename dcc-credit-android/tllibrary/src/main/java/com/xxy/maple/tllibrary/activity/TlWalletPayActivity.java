...
public abstract class TlWalletPayActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initData(String data) {
        ...
        Observable.just(data).flatMap(new Function<String, ObservableSource<BaseEntity<GaspriceNonceEntity>>>() {
            @Override
            public ObservableSource<BaseEntity<GaspriceNonceEntity>> apply(String s) throws Exception {
        ...
        }).compose(compose(this.<BaseEntity<GaspriceNonceEntity>>bindToLifecycle()))
...
//    }
    ...
    private void engineCreate(String type) {
        Observable.create(new ObservableOnSubscribe<SignParams>() {
            @Override
            public void subscribe(ObservableEmitter<SignParams> e) throws Exception {
        ...
        }).flatMap(new Function<SignParams, ObservableSource<BaseEntity>>() {
            @Override
            public ObservableSource<BaseEntity> apply(SignParams signParams) throws Exception {
    ...
    private void engineMortgage(String type, String signType) {
        ...
        if (TextUtils.equals(signType, "1")) {
            ...
            Observable.create(new ObservableOnSubscribe<SignParams>() {
                ...
                @Override
                public ObservableSource<BaseEntity> apply(SignParams authParams) throws Exception {
