...
import static com.xxy.maple.tllibrary.widget.tlprogressbar.TlSmoothProgressBarUtils.checkColors;
import static com.xxy.maple.tllibrary.widget.tlprogressbar.TlSmoothProgressBarUtils.checkNotNull;
import static com.xxy.maple.tllibrary.widget.tlprogressbar.TlSmoothProgressBarUtils.checkPositive;
import static com.xxy.maple.tllibrary.widget.tlprogressbar.TlSmoothProgressBarUtils.checkPositiveOrZero;
import static com.xxy.maple.tllibrary.widget.tlprogressbar.TlSmoothProgressBarUtils.checkSpeed;


/**
 * Created by castorflex on 11/10/13.
 */
public class TlSmoothProgressDrawable extends Drawable implements Animatable {
  ...
  private TlSmoothProgressDrawable(Interpolator interpolator,
                                   int sectionsCount,
                                   int separatorLength,
                                   int[] colors,
                                   float strokeWidth,
  ...
  public static class Builder {
    ...
    public TlSmoothProgressDrawable build() {
      if (mGenerateBackgroundUsingColors) {
        mBackgroundDrawableWhenHidden = TlSmoothProgressBarUtils.generateDrawableWithColors(mColors, mStrokeWidth);
      }
      TlSmoothProgressDrawable ret = new TlSmoothProgressDrawable(
          mInterpolator,
          mSectionsCount,
