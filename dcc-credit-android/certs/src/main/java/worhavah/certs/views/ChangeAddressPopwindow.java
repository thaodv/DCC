...
import worhavah.certs.views.wheelview.OnWheelChangedListener;
import worhavah.certs.views.wheelview.OnWheelScrollListener;
import worhavah.certs.views.wheelview.WheelView;
import worhavah.certs.views.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
	...
	public ChangeAddressPopwindow(final Context context,String[] ProvinceDatas,Map<String, String[]> CitisDatasMap,Map<String, String[]> AreaDatasMap) {
		super(context);
...
//		this.setAnimationStyle(R.style.AnimBottom);
		...
		//initJsonData();
		//initDatas();
		this.mProvinceDatas=ProvinceDatas;
		this.mCitisDatasMap=CitisDatasMap;
		this.mAreaDatasMap=AreaDatasMap;
...
//			dismiss();
	...
	public void initAreas(String[] areas) {
		if (areas != null) {
			...
			String[] area = mAreaDatasMap.get("上海市");
			arrAreas.clear();
