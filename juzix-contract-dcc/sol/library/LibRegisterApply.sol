...
library LibRegisterApply {
    ...
    */
    function toJson(RegisterApply storage _self) internal constant returns (string _json) {
        ...
        LibStack.appendKeyValue("applyTime", uint256(_self.applyTime));
        LibStack.appendKeyValue("registerUser", _self.registerUser.toJson());
        LibStack.appendKeyValue("auditList", _self.auditList.toJsonArray());
        LibStack.appendKeyValue("auditStatus", _self.auditStatus);
        LibStack.appendKeyValue("createTime", uint256(_self.createTime));
        LibStack.appendKeyValue("updateTime", uint256(_self.updateTime));
        LibStack.append("}");
        _json = LibStack.pop();
    }

    /**
    * fromJsonArray for LibRegisterApply
    * Generated by juzhen SolidityStructTool automatically.
    * Not to edit this code manually.
    */
    ...
    /**
    * toJsonArray for LibRegisterApply
    * Generated by juzhen SolidityStructTool automatically.
    * Not to edit this code manually.
    */
    ...
    */
    function update(RegisterApply storage _self, string _json) internal returns (bool succ) {
        ...
        _self.applyTime = uint256(_json.jsonRead("applyTime").toUint());
        if (_json.jsonKeyExists("registerUser"))
        _self.registerUser.fromJson(_json.jsonRead("registerUser"));
        if (_json.jsonKeyExists("auditList"))
        _self.auditList.fromJsonArray(_json.jsonRead("auditList"));
        if (_json.jsonKeyExists("auditStatus"))
        _self.auditStatus = _json.jsonRead("auditStatus").toUint();
