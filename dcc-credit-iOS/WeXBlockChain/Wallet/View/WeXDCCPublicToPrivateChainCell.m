//
//  WeXDCCPublicToPrivateChainCell.m
//  WeXBlockChain
//
...
@implementation WeXDCCPublicToPrivateChainCell
@end

@implementation WeXDCCPublicToPrivateChainFirstCell
...
- (void)setupSubViews
{
    ...
    arrowImageView.image = [UIImage imageNamed:@"across_chain_right_blue"];
    ...
    _publicBalanceLabel = balanceLabel1;
    ...
    [backImageView2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(backImageView1);
        make.leading.equalTo(arrowImageView.mas_trailing).offset(5);
        make.trailing.equalTo(self.contentView).offset(-15);
        make.height.mas_equalTo(backImageView1.mas_height);
    }];
    ...
    nameLabel2.text = @"@Distributed Credit Chain";
    ...
    _privateBalanceLabel = balanceLabel2;
    ...
    [line setContentHuggingPriority:UILayoutPriorityDefaultHigh forAxis:UILayoutConstraintAxisVertical];
}
...
-(void)layoutSubviews
{
    ...
    if (!_gradientLayer1) {
        ...
        _gradientLayer1.colors = @[(__bridge id)ColorWithHex(0x5944c3).CGColor,(__bridge id)ColorWithHex(0x8280de).CGColor];
    ...
    if (!_gradientLayer2) {
        ...
        _gradientLayer2.colors = @[(__bridge id)ColorWithHex(0xfc7c03).CGColor,(__bridge id)ColorWithHex(0xfeae6c).CGColor];
...
@implementation WeXDCCPublicToPrivateChainSecondCell
...
- (void)setupSubViews
{
    ...
    _publicBalanceLabel = privateBalanceLabel;
...
@implementation WeXDCCPublicToPrivateChainThirdCell
...
- (void)setupSubViews
{
    ...
    titelLabel.textColor = [UIColor blackColor];
    titelLabel.textAlignment = NSTextAlignmentLeft;
    [titelLabel setContentHuggingPriority:UILayoutPriorityDefaultHigh forAxis:UILayoutConstraintAxisHorizontal];
    [self.contentView addSubview:titelLabel];
    [titelLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.contentView).offset(0);
    ...
    [self.contentView addSubview:symbolLabel];
    [symbolLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(titelLabel).offset(0);
        make.trailing.equalTo(self.contentView).offset(-15);
        make.height.equalTo(titelLabel);
    ...
    [self.contentView addSubview:_valueTextField];
    [_valueTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(symbolLabel).offset(0);
        make.leading.equalTo(titelLabel.mas_trailing).offset(10);
...
@implementation WeXDCCPublicToPrivateChainFourthCell
...
- (void)setupSubViews
{
    ...
    UILabel *symobolLabel = [[UILabel alloc] init];
    symobolLabel.text = @"ETH";
    symobolLabel.font = [UIFont systemFontOfSize:16];
    symobolLabel.textColor = [UIColor blackColor];
    symobolLabel.textAlignment = NSTextAlignmentRight;
    [self.contentView addSubview:symobolLabel];
    [symobolLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.contentView).offset(0);
        make.trailing.equalTo(self.contentView).offset(-15);
        make.height.equalTo(@20);
    }];
    ...
    [feeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.contentView).offset(0);
        make.trailing.equalTo(symobolLabel.mas_leading).offset(-10);
        make.height.equalTo(@20);
    }];
    _feeLabel = feeLabel;
...
@implementation WeXDCCPublicToPrivateChainFifthCell
