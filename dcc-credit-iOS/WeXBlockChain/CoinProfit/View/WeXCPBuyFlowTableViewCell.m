...
- (void)setSaleInfoModel:(WeXCPSaleInfoResModel *)resModel {
    ...
    NSString *startBuyDay = [resModel.startTime yearToDayTimeString];
    [self.statusView setHidden:NO];
    [self.statusView setBuyTitle:@"认购开始" buyDay:startBuyDay startTitle:@"起息日" startDay:startDay endTitle:@"到期日" endDay:endDay];
