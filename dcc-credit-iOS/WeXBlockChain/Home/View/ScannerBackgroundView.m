...
-(UIView *)topView
{
    if (_topView == nil) {
        ...
        [_topView setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.6]];
    }
    return _topView;
}
-(UIView *)btmView
{
    if (_btmView == nil) {
        ...
        [_btmView setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.6]];
    }
    return _btmView;
}
...
-(UIView *)leftView
{
    if (_leftView == nil) {
        ...
        [_leftView setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.6]];
    }
    return _leftView;
}
...
-(UIView *)rightView
{
    if (_rightView == nil) {
        ...
        [_rightView setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.6]];
    }
    return _rightView;
}
/*
