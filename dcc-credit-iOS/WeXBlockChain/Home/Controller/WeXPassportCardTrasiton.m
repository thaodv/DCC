...
@interface WeXPassportCardTrasiton()
...
@implementation WeXPassportCardTrasiton
...
- (void)doPushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    WeXCardViewController *toVC = (WeXCardViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
- (void)doPopAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    WeXCardViewController *fromVC = (WeXCardViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
