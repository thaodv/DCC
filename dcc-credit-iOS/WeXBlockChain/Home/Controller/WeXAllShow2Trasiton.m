...
@implementation WeXAllShow2Trasiton
...
- (void)doPushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    WeXAllShow2ViewController *toVC = (WeXAllShow2ViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //拿到当前点击的cell的imageView
    WeXPassportCardPassCell *cell = (WeXPassportCardPassCell *)[fromVC.cardTabelView cellForRowAtIndexPath:fromVC.currentIndexPath];
...
- (void)doPopAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    WeXAllShow2ViewController *fromVC = (WeXAllShow2ViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ...
    WeXPassportCardPassCell *cell = (WeXPassportCardPassCell *)[toVC.cardTabelView cellForRowAtIndexPath:toVC.currentIndexPath];
    UIView *containerView = [transitionContext containerView];
