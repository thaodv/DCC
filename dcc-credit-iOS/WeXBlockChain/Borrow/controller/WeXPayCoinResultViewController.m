//
//  WeXPayCoinResultViewController.m
//  WeXBlockChain
//
...
@interface WeXPayCoinResultViewController ()

@end

@implementation WeXPayCoinResultViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = WeXLocalizedString(@"还币结果");
...
-(void)setupSubViews{
    ...
    locationLabel.text = WeXLocalizedString(@"还币成功");
